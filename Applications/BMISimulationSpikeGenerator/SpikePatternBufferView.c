...
bool create_spike_pattern_buffer_view_gui(void)
{
	...
	spike_pattern_graph = allocate_network_spike_pattern_graph_scroll(spike_gen_data->network, hbox, spike_pattern_graph, 3000, 1000000, 900, 1000, 100000000, spike_gen_data->spike_data);    // 3 seconds, 1000 samples/sec, 100 ms latency
