...
static void prepare_non_plastic_synapses_button_func(void)
{
	...
	for (i = 0; i < in_silico_network->layers[LAYER_BASE_SERVO_EXTENSOR_MOTOR]->neuron_groups[0]->neuron_count; i++)
	{
		neuron = get_neuron_address(in_silico_network, LAYER_BASE_SERVO_EXTENSOR_MOTOR, 0, i);					
		if (! submit_new_ps_stdp_vals_for_neuron_according_to_pre_synaptic_neuron_group(neuron, in_silico_network, LAYER_BASE_SERVO_EXTENSOR_EXCI, 0, get_maximum_parker_sochacki_order(), 0, 0, 10, 10, 0, 0, 10, 10))
		...
		if (! submit_new_ps_eligibility_vals_for_neuron_according_to_pre_synaptic_neuron_group(neuron, in_silico_network, LAYER_BASE_SERVO_EXTENSOR_EXCI, 0, get_maximum_parker_sochacki_order(), 10, 10, 0, 0, 1, 0, -50, -50))
	...
	for (i = 0; i < in_silico_network->layers[LAYER_BASE_SERVO_FLEXOR_MOTOR]->neuron_groups[0]->neuron_count; i++)
	{
		neuron = get_neuron_address(in_silico_network, LAYER_BASE_SERVO_FLEXOR_MOTOR, 0, i);					
		if (! submit_new_ps_stdp_vals_for_neuron_according_to_pre_synaptic_neuron_group(neuron, in_silico_network, LAYER_BASE_SERVO_FLEXOR_EXCI, 0, get_maximum_parker_sochacki_order(), 0, 0, 10, 10, 0, 0, 10, 10))
			return (void)print_message(ERROR_MSG ,"HybridNetRLBMI", "NetworkView", "prepare_non_plastic_synapses_button_func", "! submit_new_ps_stdp_vals_for_neuron_according_to_pre_synaptic_neuron_group().");
		if (! submit_new_ps_eligibility_vals_for_neuron_according_to_pre_synaptic_neuron_group(neuron, in_silico_network, LAYER_BASE_SERVO_FLEXOR_EXCI, 0, get_maximum_parker_sochacki_order(), 10, 10, 0, 0, 1, 0, -50, -50))
			return (void)print_message(ERROR_MSG ,"HybridNetRLBMI", "NetworkView", "prepare_non_plastic_synapses_button_func", "! submit_new_ps_eligibility_vals_for_neuron_according_to_pre_synaptic_neuron_group().");
	}	
	for (i = 0; i < in_silico_network->layers[LAYER_BASE_SERVO_STATION_MOTOR]->neuron_groups[0]->neuron_count; i++)
	{
		neuron = get_neuron_address(in_silico_network, LAYER_BASE_SERVO_STATION_MOTOR, 0, i);					
		if (! submit_new_ps_stdp_vals_for_neuron_according_to_pre_synaptic_neuron_group(neuron, in_silico_network, LAYER_BASE_SERVO_STATION_EXCI, 0, get_maximum_parker_sochacki_order(), 0, 0, 10, 10, 0, 0, 10, 10))
			return (void)print_message(ERROR_MSG ,"HybridNetRLBMI", "NetworkView", "prepare_non_plastic_synapses_button_func", "! submit_new_ps_stdp_vals_for_neuron_according_to_pre_synaptic_neuron_group().");
		if (! submit_new_ps_eligibility_vals_for_neuron_according_to_pre_synaptic_neuron_group(neuron, in_silico_network, LAYER_BASE_SERVO_STATION_EXCI, 0, get_maximum_parker_sochacki_order(), 10, 10, 0, 0, 1, 0, -50, -50))
			return (void)print_message(ERROR_MSG ,"HybridNetRLBMI", "NetworkView", "prepare_non_plastic_synapses_button_func", "! submit_new_ps_eligibility_vals_for_neuron_according_to_pre_synaptic_neuron_group().");
	}	
