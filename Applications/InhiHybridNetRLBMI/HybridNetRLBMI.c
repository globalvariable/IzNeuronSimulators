...
int main( int argc, char *argv[])
{
	...
	if (! connect_excitatory_neurons_of_motor_neurons(hybrid_net_rl_bmi_data)) {
		print_message(ERROR_MSG ,"HybridNetRLBMI", "HybridNetRLBMI", "main", "! connect_excitatory_neurons_of_motor_neurons()."); return -1; }
