...
#include "../../Library/PoissonFiring/PoissonFiring.h"
...
{
	SortedSpikes	 				*sorted_spike_time_stamp;    /// spike time stamps from biological neurons 
	...
	ThreePhasePoissonFiring		*firing_rate_data;
};
