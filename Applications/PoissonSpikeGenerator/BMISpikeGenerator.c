...
int main( int argc, char *argv[])
{
	...
	bmi_simulation_spike_gen_data->trial_hand_paradigm->max_trial_length = 10000000000;
	bmi_simulation_spike_gen_data->trial_hand_paradigm->min_trial_refractory = 10000000000;
