...
#define MAXIMUM_IN_SILICO_TO_IN_SILICO_AXONAL_DELAY MINIMUM_IN_SILICO_TO_IN_SILICO_AXONAL_DELAY + 2000000   // it can be increased but it will lead to increase in event buffer size of neurons
...
#define MAXIMUM_BLUE_SPIKE_TO_IN_SILICO_AXONAL_DELAY MINIMUM_BLUE_SPIKE_TO_IN_SILICO_AXONAL_DELAY + 2000000 // it can be increased but it will lead to increase in event buffer size of neurons
