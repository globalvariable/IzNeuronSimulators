...
bool determine_stdp_graph_scroll_limited_start_indexes(STDPGraphScrollLimited *graph, TimeStamp last_sample_time, unsigned int stdp_limited_buffer_write_idx, unsigned int stdp_limited_buffer_size)
{
