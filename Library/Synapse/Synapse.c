...
bool create_synapse(Neuron *this_neuron, Neuron *target_neuron, SynapticWeight weight_excitatory_max, SynapticWeight weight_excitatory_min, SynapticWeight weight_inhibitory_max, SynapticWeight weight_inhibitory_min, SynapticDelay EPSP_delay_min, SynapticDelay EPSP_delay_max, SynapticDelay IPSP_delay_min, SynapticDelay IPSP_delay_max, double excitatory_connection_probability, double inhibitory_connection_probability, bool *did_connection)	// created synapse from internal network to itself
{
...
bool create_synapse_from_ext_neuron_to_int_neuron(ExtNeuron *this_neuron, Neuron *target_neuron, SynapticWeight weight_excitatory_max, SynapticWeight weight_excitatory_min, SynapticWeight weight_inhibitory_max, SynapticWeight weight_inhibitory_min, SynapticDelay EPSP_delay_min, SynapticDelay EPSP_delay_max, SynapticDelay IPSP_delay_min, SynapticDelay IPSP_delay_max, double excitatory_connection_probability, double inhibitory_connection_probability, bool *did_connection)
{
	...
	*did_connection = FALSE;
	if (EPSP_delay_min>EPSP_delay_max)
		return print_message(ERROR_MSG ,"IzNeuronSimulators", "Synapse", "create_synapse_from_ext_neuron_to_int_neuron", "EPSP_delay_min>EPSP_delay_max.");	 
	if (IPSP_delay_min>IPSP_delay_max)
		return print_message(ERROR_MSG ,"IzNeuronSimulators", "Synapse", "create_synapse_from_ext_neuron_to_int_neuron", "IPSP_delay_min>IPSP_delay_max.");	
	if (weight_excitatory_min > weight_excitatory_max)
		return print_message(ERROR_MSG ,"IzNeuronSimulators", "Synapse", "create_synapse_from_ext_neuron_to_int_neuron", "weight_excitatory_min > weight_excitatory_max.");	
 	if (weight_inhibitory_min > weight_inhibitory_max)
		return print_message(ERROR_MSG ,"IzNeuronSimulators", "Synapse", "create_synapse_from_ext_neuron_to_int_neuron", "weight_inhibitory_min > weight_inhibitory_max.");	
 	if (weight_excitatory_min<=0)
		return print_message(ERROR_MSG ,"IzNeuronSimulators", "Synapse", "create_synapse_from_ext_neuron_to_int_neuron", "weight_excitatory_min<=0.");	
 	if (weight_inhibitory_min<=0)
		return print_message(ERROR_MSG ,"IzNeuronSimulators", "Synapse", "create_synapse_from_ext_neuron_to_int_neuron", "weight_excitatory_min<=0.");	
 	if (weight_excitatory_max<=0)
